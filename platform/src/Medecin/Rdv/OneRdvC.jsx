    ...
    return (
        <>
            <tr>
                ...
                <td>{rdv.daterdv || "N/A"}</td>
                <td>{rdv.heurerdv || "N/A"}</td>
                <td>{rdv.hopitalrdv || "N/A"}</td>
                <td>{rdv.TypeDeRdv || "N/A"}</td>
                <td>{rdv.TypeDeConsultation || "N/A"}</td>
                <td>{rdv.Motif || "N/A"}</td>
                <td >
                    <button  className="Accept" onClick={() => setIsPopupOpen(true)}>modifier</button>
                </td>
            </tr>
