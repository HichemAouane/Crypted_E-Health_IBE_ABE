...
const NavbarProfilP = ({ toggleSidebar }) => {
    ...
    const handleProfileNavigation = () => {
        navigate(user?.role === "Medecin" ? "/info" : "/infop");
    };
  return (
    <nav className="navbar">
        ...
        {user?.sexe === "Masculin" ? `Mr. ${user?.nom || "Utilisateur"}` : `Mme. ${user?.nom || "Utilisateur"}`}
        </span>
